...
setwd("C:/Users/cara.estes/Documents/Spring_2020/RVC_regions_tables/IEA_output")
...
export(DT_richness_frame,"DT_richness_plot.csv")
export(DT_simpson_frame,"DT_simpson_plot.csv")
export(DT_shannon_frame,"DT_shannon_plot.csv")
export(LK_richness_frame,"LK_richness_plot.csv")
export(LK_simpson_frame,"LK_simpson_plot.csv")
export(LK_shannon_frame,"LK_shannon_plot.csv")
export(MK_richness_frame,"MK_richness_plot.csv")
export(MK_simpson_frame,"MK_simpson_plot.csv")
export(MK_shannon_frame,"MK_shannon_plot.csv")
export(UK_richness_frame,"UK_richness_plot.csv")
export(UK_simpson_frame,"UK_simpson_plot.csv")
export(UK_shannon_frame,"UK_shannon_plot.csv")
export(SEF_richness_frame,"SEF_richness_plot.csv")
export(SEF_simpson_frame,"SEF_simpson_plot.csv")
export(SEF_shannon_frame,"SEF_shannon_plot.csv")
...
DT_richness_IEA_plot <- read.delim("DT_richness_plot.csv", sep=",")



DT_richness_plot <- melt(DT_richness_IEA_plot, id.vars = "YEAR")


### plot
ggplot(DT_richness_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Species Richness", subtitle = "Dry Tortugas")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(DT_richness_plot$YEAR), max(DT_richness_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
...
ggsave ("plots/DT_richness.png", width = 8, height = 4)



## Simpson 

DT_simpson_IEA_plot <- read.delim("DT_simpson_plot.csv", sep=",")



DT_simpson_plot <- melt(DT_simpson_IEA_plot, id.vars = "YEAR")


### plot
ggplot(DT_simpson_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Simpson Diversity Index", subtitle = "Dry Tortugas")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(DT_simpson_plot$YEAR), max(DT_simpson_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/DT_simpson.png", width = 8, height = 4)


### Shannon 


DT_shannon_IEA_plot <- read.delim("DT_shannon_plot.csv", sep=",")



DT_shannon_plot <- melt(DT_shannon_IEA_plot, id.vars = "YEAR")


### plot
ggplot(DT_shannon_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Shannon Diversity Index", subtitle = "Dry Tortugas")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(DT_shannon_plot$YEAR), max(DT_shannon_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/DT_shannon.png", width = 8, height = 4)
...
LK_richness_IEA_plot <- read.delim("LK_richness_plot.csv", sep=",")



LK_richness_plot <- melt(LK_richness_IEA_plot, id.vars = "YEAR")


### plot
ggplot(LK_richness_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Species Richness", subtitle = "Lower Keys")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(LK_richness_plot$YEAR), max(LK_richness_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/LK_richness.png", width = 8, height = 4)



## Simpson 

LK_simpson_IEA_plot <- read.delim("LK_simpson_plot.csv", sep=",")



LK_simpson_plot <- melt(LK_simpson_IEA_plot, id.vars = "YEAR")


### plot
ggplot(LK_simpson_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Simpson Diversity Index", subtitle = "Lower Keys")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(LK_simpson_plot$YEAR), max(LK_simpson_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/LK_simpson.png", width = 8, height = 4)


### Shannon 


LK_shannon_IEA_plot <- read.delim("LK_shannon_plot.csv", sep=",")



LK_shannon_plot <- melt(LK_shannon_IEA_plot, id.vars = "YEAR")


### plot
ggplot(LK_shannon_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Shannon Diversity Index", subtitle = "Lower Keys")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(LK_shannon_plot$YEAR), max(LK_shannon_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/LK_shannon.png", width = 8, height = 4)
...
MK_richness_IEA_plot <- read.delim("MK_richness_plot.csv", sep=",")



MK_richness_plot <- melt(MK_richness_IEA_plot, id.vars = "YEAR")


### plot
ggplot(MK_richness_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Species Richness", subtitle = "Middle Keys")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(MK_richness_plot$YEAR), max(MK_richness_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/MK_richness.png", width = 8, height = 4)



## Simpson 

MK_simpson_IEA_plot <- read.delim("MK_simpson_plot.csv", sep=",")



MK_simpson_plot <- melt(MK_simpson_IEA_plot, id.vars = "YEAR")


### plot
ggplot(MK_simpson_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Simpson Diversity Index", subtitle = "Middle Keys")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(MK_simpson_plot$YEAR), max(MK_simpson_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/MK_simpson.png", width = 8, height = 4)


### Shannon 


MK_shannon_IEA_plot <- read.delim("MK_shannon_plot.csv", sep=",")



MK_shannon_plot <- melt(MK_shannon_IEA_plot, id.vars = "YEAR")


### plot
ggplot(MK_shannon_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Shannon Diversity Index", subtitle = "Middle Keys")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(MK_shannon_plot$YEAR), max(MK_shannon_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/MK_shannon.png", width = 8, height = 4)
...
UK_richness_IEA_plot <- read.delim("UK_richness_plot.csv", sep=",")



UK_richness_plot <- melt(UK_richness_IEA_plot, id.vars = "YEAR")


### plot
ggplot(UK_richness_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Species Richness", subtitle = "Upper Keys")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(UK_richness_plot$YEAR), max(UK_richness_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/UK_richness.png", width = 8, height = 4)



## Simpson 

UK_simpson_IEA_plot <- read.delim("UK_simpson_plot.csv", sep=",")



UK_simpson_plot <- melt(UK_simpson_IEA_plot, id.vars = "YEAR")


### plot
ggplot(UK_simpson_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Simpson Diversity Index", subtitle = "Upper Keys")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(UK_simpson_plot$YEAR), max(UK_simpson_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/UK_simpson.png", width = 8, height = 4)


### Shannon 


UK_shannon_IEA_plot <- read.delim("UK_shannon_plot.csv", sep=",")



UK_shannon_plot <- melt(UK_shannon_IEA_plot, id.vars = "YEAR")


### plot
ggplot(UK_shannon_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Shannon Diversity Index", subtitle = "Upper Keys")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(UK_shannon_plot$YEAR), max(UK_shannon_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/UK_shannon.png", width = 8, height = 4)
...
SEF_richness_IEA_plot <- read.delim("SEF_richness_plot.csv", sep=",")



SEF_richness_plot <- melt(SEF_richness_IEA_plot, id.vars = "YEAR")


### plot
ggplot(SEF_richness_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Species Richness", subtitle = "SE Florida ")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(SEF_richness_plot$YEAR), max(SEF_richness_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/SEF_richness.png", width = 8, height = 4)



## Simpson 

SEF_simpson_IEA_plot <- read.delim("SEF_simpson_plot.csv", sep=",")



SEF_simpson_plot <- melt(SEF_simpson_IEA_plot, id.vars = "YEAR")


### plot
ggplot(SEF_simpson_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Simpson Diversity Index", subtitle = "SE Florida ")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(SEF_simpson_plot$YEAR), max(SEF_simpson_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/SEF_simpson.png", width = 8, height = 4)


### Shannon 


SEF_shannon_IEA_plot <- read.delim("SEF_shannon_plot.csv", sep=",")



SEF_shannon_plot <- melt(SEF_shannon_IEA_plot, id.vars = "YEAR")


### plot
ggplot(SEF_shannon_plot, aes(YEAR, value, fill=variable))+
  ggtitle("Shannon Diversity Index", subtitle = "SE Florida ")+
  geom_line(size = 1)+
  geom_point()+
  scale_x_continuous(breaks = round(seq(min(SEF_shannon_plot$YEAR), max(SEF_shannon_plot$YEAR), by = 2),1))+
  theme_light()+
  theme(
    plot.title = element_text(hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5),
...
ggsave ("plots/SEF_shannon.png", width = 8, height = 4)
