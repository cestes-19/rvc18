...
Bird_Key_Reef_serc <- import("DT_5km/Bird_Key_Reef_serc.xls")
Bird_Key_Reef_ws <- import("DT_5km/Bird_Key_Reef_ws.xls")
...
unique(Bird_Key_Reef_serc_year$Year)
unique(Bird_Key_Reef_ws_year$Year)
...
export(Bird_Key_Reef_all,"DT_5km/Bird_Key_Reef_combined.csv")




Black_Coral_Rock_serc <- import("DT_5km/Black_Coral_Rock_serc.xls")
Black_Coral_Rock_ws <- import("DT_5km/Black_Coral_Rock_ws.xls")
...
#unique(data.frame)  will show the years each df has,, this helps with adding an ID column to the data
#   add id row for all ws (always less than serc) and then pull out remaining years of serc to combine at end
unique(Black_Coral_Rock_serc_year$Year)
unique(Black_Coral_Rock_ws_year$Year)
...
Black_Coral_Rock_serc_extra <- rbind(Black_Coral_Rock_serc_1995,Black_Coral_Rock_serc_1996,Black_Coral_Rock_serc_1997,Black_Coral_Rock_serc_1999,Black_Coral_Rock_serc_2000,Black_Coral_Rock_serc_2001,Black_Coral_Rock_serc_2005,Black_Coral_Rock_serc_2007,Black_Coral_Rock_serc_2008,Black_Coral_Rock_serc_2009,Black_Coral_Rock_serc_2010,Black_Coral_Rock_serc_2011)
...
Black_Coral_Rock_all <- rbind(Black_Coral_Rock_serc_extra,Black_Coral_Rock_2002_all,Black_Coral_Rock_2003_all,Black_Coral_Rock_2004_all,Black_Coral_Rock_2006_all)
Black_Coral_Rock_all$sitename <- "Black_Coral_Rock"


export(Black_Coral_Rock_all,"DT_5km/Black_Coral_Rock_combined.csv")




Davis_Rock_serc <- import("DT_5km/Davis_Rock_serc.xls")
Davis_Rock_ws <- import("DT_5km/Davis_Rock_ws.xls")
...
#unique(data.frame)  will show the years each df has,, this helps with adding an ID column to the data
#   add id row for all ws (always less than serc) and then pull out remaining years of serc to combine at end
unique(Davis_Rock_serc_year$Year)
unique(Davis_Rock_ws_year$Year)
...
Davis_Rock_serc_extra <- rbind(Davis_Rock_serc_1995,Davis_Rock_serc_1996,Davis_Rock_serc_1997,Davis_Rock_serc_1998,Davis_Rock_serc_1999,Davis_Rock_serc_2000,Davis_Rock_serc_2001,Davis_Rock_serc_2007,Davis_Rock_serc_2008,Davis_Rock_serc_2009,Davis_Rock_serc_2010,Davis_Rock_serc_2011)
...
Davis_Rock_all <- rbind(Davis_Rock_serc_extra,Davis_Rock_2002_all,Davis_Rock_2003_all,Davis_Rock_2004_all, Davis_Rock_2005_all,Davis_Rock_2006_all)
Davis_Rock_all$sitename <- "Davis_Rock"


export(Davis_Rock_all,"DT_5km/Davis_Rock_combined.csv")




Loggerhead_Patch_serc <- import("DT_5km/Loggerhead_Patch_serc.xls")
Loggerhead_Patch_ws <- import("DT_5km/Loggerhead_Patch_ws.xls")
...
export(Loggerhead_Patch_all,"DT_5km/Loggerhead_Patch_combined.csv")



Mayers_Peak_serc <- import("DT_5km/Mayers_Peak_serc.xls")
Mayers_Peak_ws <- import("DT_5km/Mayers_Peak_ws.xls")
...
export(Mayers_Peak_all,"DT_5km/Mayers_Peak_combined.csv")



Palmata_Patch_serc <- import("DT_5km/Palmata_Patch_serc.xls")
Palmata_Patch_ws <- import("DT_5km/Palmata_Patch_ws.xls")
...
export(Palmata_Patch_all,"DT_5km/Palmata_Patch_combined.csv")



Prolifera_Patch_serc <- import("DT_5km/Prolifera_Patch_serc.xls")
Prolifera_Patch_ws <- import("DT_5km/Prolifera_Patch_ws.xls")
...
export(Prolifera_Patch_all,"DT_5km/Prolifera_Patch_combined.csv")



Temptation_Rock_serc <- import("DT_5km/Temptation_Rock_serc.xls")
Temptation_Rock_ws <- import("DT_5km/Temptation_Rock_ws.xls")
...
export(Temptation_Rock_all,"DT_5km/Temptation_Rock_combined.csv")


Texas_Rock_serc <- import("DT_5km/Texas_Rock_serc.xls")
Texas_Rock_ws <- import("DT_5km/Texas_Rock_ws.xls")
...
Texas_Rock_serc_extra <- rbind(Texas_Rock_serc_1995,Texas_Rock_serc_1996,Texas_Rock_serc_1997,Texas_Rock_serc_1998,Texas_Rock_serc_1999,Texas_Rock_serc_2000,Texas_Rock_serc_2001,Texas_Rock_serc_2007,Texas_Rock_serc_2008,Texas_Rock_serc_2009,Texas_Rock_serc_2010,Texas_Rock_serc_2011)
...
Texas_Rock_all <- rbind(Texas_Rock_serc_extra,Texas_Rock_2002_all,Texas_Rock_2003_all,Texas_Rock_2004_all, Texas_Rock_2005_all,Texas_Rock_2006_all)
Texas_Rock_all$sitename <- "Texas_Rock"

export(Texas_Rock_all,"DT_5km/Texas_Rock_combined.csv")


The_Maze_serc <- import("DT_5km/The_Maze_serc.xls")
The_Maze_ws <- import("DT_5km/The_Maze_ws.xls")
...
export(The_Maze_all,"DT_5km/The_Maze_combined.csv")


White_Shoal_serc <- import("DT_5km/White_Shoal_serc.xls")
White_Shoal_ws <- import("DT_5km/White_Shoal_ws.xls")
...
export(White_Shoal_all,"DT_5km/White_Shoal_combined.csv")
...
export(Dry_Tortugas_all,"DT_5km/DT_Nutrients_Combined.csv")
...
Cliff_Green_serc <- import("LK_5km/Cliff_Green_serc.xls")
#Cliff_Green_ws <- import("LK_5km/Cliff_Green_ws.xls")
...
# 
# 
Cliff_Green_serc_year$Longitude <- "NA"
Cliff_Green_serc_year$Latitude <- "NA"
Cliff_Green_serc_year$Depth <- "NA"
Cliff_Green_serc_year$SST <- "NA"
Cliff_Green_serc_year$SSS <- "NA"
Cliff_Green_serc_year$Chl_a <- "NA"
Cliff_Green_serc_year$Phaeophyti <- "NA"
Cliff_Green_serc_year$id <- "NA"
# 
# 
...
Cliff_Green_serc_year$sitename <- "Cliff_Green"

export(Cliff_Green_serc_year,"LK_5km/Cliff_Green_combined.csv")




Eastern_Sambo_Deep_serc <- import("LK_5km/Eastern_Sambo_Deep_serc.xls")
Eastern_Sambo_Deep_ws <- import("LK_5km/Eastern_Sambo_Deep_ws.xls")
...
Eastern_Sambo_Deep_serc_2002 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2002")
Eastern_Sambo_Deep_serc_2003 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2003")
Eastern_Sambo_Deep_serc_2004 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2004")
Eastern_Sambo_Deep_serc_2005 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2005")
Eastern_Sambo_Deep_serc_2006 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2006")
Eastern_Sambo_Deep_serc_2007 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2007")
Eastern_Sambo_Deep_serc_2008 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2008")
Eastern_Sambo_Deep_serc_2009 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2009")
Eastern_Sambo_Deep_serc_2010 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2010")
Eastern_Sambo_Deep_serc_2011 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2011")
Eastern_Sambo_Deep_serc_2012 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2012")
Eastern_Sambo_Deep_serc_2013 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2013")
Eastern_Sambo_Deep_serc_2014 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2014")
Eastern_Sambo_Deep_serc_2016 <- subset(Eastern_Sambo_Deep_serc_year, Year == "2016")



Eastern_Sambo_Deep_serc_extra <- rbind(Eastern_Sambo_Deep_serc_1995,Eastern_Sambo_Deep_serc_1996,Eastern_Sambo_Deep_serc_1997,Eastern_Sambo_Deep_serc_1998,Eastern_Sambo_Deep_serc_1999,Eastern_Sambo_Deep_serc_2000,
                                       Eastern_Sambo_Deep_serc_2001,Eastern_Sambo_Deep_serc_2002,Eastern_Sambo_Deep_serc_2003,
                                       Eastern_Sambo_Deep_serc_2004,Eastern_Sambo_Deep_serc_2005,Eastern_Sambo_Deep_serc_2006,
                                       Eastern_Sambo_Deep_serc_2007,Eastern_Sambo_Deep_serc_2008,Eastern_Sambo_Deep_serc_2009,
                                       Eastern_Sambo_Deep_serc_2010,Eastern_Sambo_Deep_serc_2011,Eastern_Sambo_Deep_serc_2012,
                                       Eastern_Sambo_Deep_serc_2013,Eastern_Sambo_Deep_serc_2014,Eastern_Sambo_Deep_serc_2016)
...
Eastern_Sambo_Deep_all <- rbind(Eastern_Sambo_Deep_serc_extra,Eastern_Sambo_Deep_2015_all,Eastern_Sambo_Deep_2017_all)
Eastern_Sambo_Deep_all$sitename <- "Eastern_Sambo_Deep"

export(Eastern_Sambo_Deep_all,"LK_5km/Eastern_Sambo_Deep_combined.csv")




Eastern_Sambo_Shallow_serc <- import("LK_5km/Eastern_Sambo_Shallow_serc.xls")
#Eastern_Sambo_Shallow_ws <- import("LK_5km/Eastern_Sambo_Shallow_ws.xls")
...
Eastern_Sambo_Shallow_serc_year$Longitude <- "NA"
Eastern_Sambo_Shallow_serc_year$Latitude <- "NA"
Eastern_Sambo_Shallow_serc_year$Depth <- "NA"
Eastern_Sambo_Shallow_serc_year$SST <- "NA"
Eastern_Sambo_Shallow_serc_year$SSS <- "NA"
Eastern_Sambo_Shallow_serc_year$Chl_a <- "NA"
Eastern_Sambo_Shallow_serc_year$Phaeophyti <- "NA"
Eastern_Sambo_Shallow_serc_year$id <- "NA"
...
Eastern_Sambo_Shallow_serc_year$sitename <- "Eastern_Sambo_Shallow"

export(Eastern_Sambo_Shallow_serc_year,"LK_5km/Eastern_Sambo_Shallow_combined.csv")


#### No data for ws for Jaap Reef........ so load serc data, add columns from ws, and export 
# 
Jaap_Reef_serc <- import("LK_5km/Jaap_Reef_serc.xls")
# Jaap_Reef_ws <- import("LK_5km/Jaap_Reef_ws.xls")
# 
# ## Change date to Year to merge the two dataframes
# 
...
export(Jaap_Reef_serc_year,"LK_5km/Jaap_Reef_combined.csv")



Looe_Key_Deep_serc <- import("LK_5km/Looe_Key_Deep_serc.xls")
Looe_Key_Deep_ws <- import("LK_5km/Looe_Key_Deep_ws.xls")
...
export(Looe_Key_Deep_all,"LK_5km/Looe_Key_Deep_combined.csv")



Looe_Key_Shallow_serc <- import("LK_5km/Looe_Key_Shallow_serc.xls")
Looe_Key_Shallow_ws <- import("LK_5km/Looe_Key_Shallow_ws.xls")
...
export(Looe_Key_Shallow_all,"LK_5km/Looe_Key_Shallow_combined.csv")




Red_Dun_Reef_serc <- import("LK_5km/Red_Dun_Reef_serc.xls")
#Red_Dun_Reef_ws <- import("LK_5km/Red_Dun_Reef_ws.xls")
...
Red_Dun_Reef_serc_year$Longitude <- "NA"
Red_Dun_Reef_serc_year$Latitude <- "NA"
Red_Dun_Reef_serc_year$Depth <- "NA"
Red_Dun_Reef_serc_year$SST <- "NA"
Red_Dun_Reef_serc_year$SSS <- "NA"
Red_Dun_Reef_serc_year$Chl_a <- "NA"
Red_Dun_Reef_serc_year$Phaeophyti <- "NA"
Red_Dun_Reef_serc_year$id <- "NA"
...
Red_Dun_Reef_serc_year$sitename <- "Red_Dun_Reef"

export(Red_Dun_Reef_serc_year,"LK_5km/Red_Dun_Reef_combined.csv")



Rock_Key_Deep_serc <- import("LK_5km/Rock_Key_Deep_serc.xls")
Rock_Key_Deep_ws <- import("LK_5km/Rock_Key_Deep_ws.xls")
...
export(Rock_Key_Deep_all,"LK_5km/Rock_Key_Deep_combined.csv")



Rock_Key_Shallow_serc <- import("LK_5km/Rock_Key_Shallow_serc.xls")
Rock_Key_Shallow_ws <- import("LK_5km/Rock_Key_Shallow_ws.xls")
...
export(Rock_Key_Shallow_all,"LK_5km/Rock_Key_Shallow_combined.csv")



Sand_Key_Deep_serc <- import("LK_5km/Sand_Key_Deep_serc.xls")
#Sand_Key_Deep_ws <- import("LK_5km/Sand_Key_Deep_ws.xls")
...
Sand_Key_Deep_serc_year$Longitude <- "NA"
Sand_Key_Deep_serc_year$Latitude <- "NA"
Sand_Key_Deep_serc_year$Depth <- "NA"
Sand_Key_Deep_serc_year$SST <- "NA"
Sand_Key_Deep_serc_year$SSS <- "NA"
Sand_Key_Deep_serc_year$Chl_a <- "NA"
Sand_Key_Deep_serc_year$Phaeophyti <- "NA"
Sand_Key_Deep_serc_year$id <- "NA"
...
Sand_Key_Deep_serc_year$sitename <- "Sand_Key_Deep"

export(Sand_Key_Deep_serc_year,"LK_5km/Sand_Key_Deep_combined.csv")





Sand_Key_Shallow_serc <- import("LK_5km/Sand_Key_Shallow_serc.xls")
Sand_Key_Shallow_ws <- import("LK_5km/Sand_Key_Shallow_ws.xls")
...
Sand_Key_Shallow_serc_extra <- rbind(Sand_Key_Shallow_serc_1995,Sand_Key_Shallow_serc_1996,Sand_Key_Shallow_serc_1997,Sand_Key_Shallow_serc_1998,Sand_Key_Shallow_serc_1999,Sand_Key_Shallow_serc_2000,
                                       Sand_Key_Shallow_serc_2001,Sand_Key_Shallow_serc_2002,Sand_Key_Shallow_serc_2003,
                                       Sand_Key_Shallow_serc_2004,Sand_Key_Shallow_serc_2005,Sand_Key_Shallow_serc_2006,
                                       Sand_Key_Shallow_serc_2007,Sand_Key_Shallow_serc_2008,Sand_Key_Shallow_serc_2009,
                                       Sand_Key_Shallow_serc_2010,Sand_Key_Shallow_serc_2011,Sand_Key_Shallow_serc_2012,
                                       Sand_Key_Shallow_serc_2013,Sand_Key_Shallow_serc_2014,Sand_Key_Shallow_serc_2015,
                                       Sand_Key_Shallow_serc_2016)
...
Sand_Key_Shallow_all <- rbind(Sand_Key_Shallow_serc_extra,Sand_Key_Shallow_2017_all)
  Sand_Key_Shallow_all$sitename <- "Sand_Key_Shallow"

export(Sand_Key_Shallow_all,"LK_5km/Sand_Key_Shallow_combined.csv")



### Only serc data

West_Washer_Woman_serc <- import("LK_5km/West_Washer_Woman_serc.xls")
#West_Washer_Woman_ws <- import("LK_5km/West_Washer_Woman_ws.xls")
...
export(West_Washer_Woman_serc_year,"LK_5km/West_Washer_Woman_combined.csv")





Western_Head_serc <- import("LK_5km/Western_Head_serc.xls")
Western_Head_ws <- import("LK_5km/Western_Head_ws.xls")
...
export(Western_Head_all,"LK_5km/Western_Head_combined.csv")



Western_Sambo_Deep_serc <- import("LK_5km/Western_Sambo_Deep_serc.xls")
Western_Sambo_Deep_ws <- import("LK_5km/Western_Sambo_Deep_ws.xls")
...
export(Western_Sambo_Deep_all,"LK_5km/Western_Sambo_Deep_combined.csv")



Western_Sambo_Shallow_serc <- import("LK_5km/Western_Sambo_Shallow_serc.xls")
Western_Sambo_Shallow_ws <- import("LK_5km/Western_Sambo_Shallow_ws.xls")
...
export(Western_Sambo_Shallow_all,"LK_5km/Western_Sambo_Shallow_combined.csv")



Wonderland_serc <- import("LK_5km/Wonderland_serc.xls")
#Wonderland_ws <- import("LK_5km/Wonderland_ws.xls")
...
Wonderland_serc_year$Longitude <- "NA"
Wonderland_serc_year$Latitude <- "NA"
Wonderland_serc_year$Depth <- "NA"
Wonderland_serc_year$SST <- "NA"
Wonderland_serc_year$SSS <- "NA"
Wonderland_serc_year$Chl_a <- "NA"
Wonderland_serc_year$Phaeophyti <- "NA"
Wonderland_serc_year$id <- "NA"
...
Wonderland_serc_year$sitename <- "Wonderland"

export(Wonderland_serc_year,"LK_5km/Wonderland_combined.csv")


### Combine Lower Keys

Lower_Keys_all <- rbind(Cliff_Green_serc_year,Eastern_Sambo_Deep_all
                        ,Eastern_Sambo_Shallow_serc_year,Jaap_Reef_serc_year,
                        Looe_Key_Deep_all,Looe_Key_Shallow_all,
                        Red_Dun_Reef_serc_year,Rock_Key_Deep_all,Rock_Key_Shallow_all,
                        Sand_Key_Deep_serc_year,Sand_Key_Shallow_all,
                        West_Washer_Woman_serc_year,Western_Head_all,
                        Western_Sambo_Deep_all,Western_Sambo_Shallow_all,Wonderland_serc_year)


export(Lower_Keys_all,"LK_5km/LK_Nutrients_Combined.csv")
...
Alligator_Deep_serc <- import("MK_5km/Alligator_Deep_serc.xls")
# Alligator_Deep_ws <- import("MK_5km/Alligator_Deep_ws.xls")
...
export(Alligator_Deep_serc_year,"MK_5km/Alligator_Deep_combined.csv")



Alligator_Shallow_serc <- import("MK_5km/Alligator_Shallow_serc.xls")
# Alligator_Shallow_ws <- import("MK_5km/Alligator_Shallow_ws.xls")
...
export(Alligator_Shallow_serc_year,"MK_5km/Alligator_Shallow_combined.csv")




Dustan_Rocks_serc <- import("MK_5km/Dustan_Rocks_serc.xls")
Dustan_Rocks_ws <- import("MK_5km/Dustan_Rocks_ws.xls")
...
export(Dustan_Rocks_all,"MK_5km/Dustan_Rocks_combined.csv")



Long_Key_serc <- import("MK_5km/Long_Key_serc.xls")
Long_Key_ws <- import("MK_5km/Long_Key_ws.xls")
...
export(Long_Key_all,"MK_5km/Long_Key_combined.csv")





Molasses_Keys_serc <- import("MK_5km/Molasses_Keys_serc.xls")
Molasses_Keys_ws <- import("MK_5km/Molasses_Keys_ws.xls")
...
export(Molasses_Keys_all,"MK_5km/Molasses_Keys_combined.csv")



Moser_Channel_serc <- import("MK_5km/Moser_Channel_serc.xls")
Moser_Channel_ws <- import("MK_5km/Moser_Channel_ws.xls")
...
export(Moser_Channel_all,"MK_5km/Moser_Channel_combined.csv")



Rawa_Reef_serc <- import("MK_5km/Rawa_Reef_serc.xls")
#Rawa_Reef_ws <- import("MK_5km/Rawa_Reef_ws.xls")
...
Rawa_Reef_serc_year$Longitude <- "NA"
Rawa_Reef_serc_year$Latitude <- "NA"
Rawa_Reef_serc_year$Depth <- "NA"
Rawa_Reef_serc_year$SST <- "NA"
Rawa_Reef_serc_year$SSS <- "NA"
Rawa_Reef_serc_year$Chl_a <- "NA"
Rawa_Reef_serc_year$Phaeophyti <- "NA"
Rawa_Reef_serc_year$id <- "NA"
...
Rawa_Reef_serc_year$sitename <- "Rawa_Reef"

export(Rawa_Reef_serc_year,"MK_5km/Rawa_Reef_combined.csv")




Sombrero_Deep_serc <- import("MK_5km/Sombrero_Deep_serc.xls")
Sombrero_Deep_ws <- import("MK_5km/Sombrero_Deep_ws.xls")
...
Sombrero_Deep_serc_extra <- rbind(Sombrero_Deep_serc_1995,Sombrero_Deep_serc_1996,Sombrero_Deep_serc_1997,Sombrero_Deep_serc_1998,Sombrero_Deep_serc_1999,Sombrero_Deep_serc_2000,
                                       Sombrero_Deep_serc_2001,Sombrero_Deep_serc_2002,Sombrero_Deep_serc_2003,
                                       Sombrero_Deep_serc_2004,Sombrero_Deep_serc_2005,Sombrero_Deep_serc_2006,
                                       Sombrero_Deep_serc_2007,Sombrero_Deep_serc_2008,Sombrero_Deep_serc_2009,
                                       Sombrero_Deep_serc_2010,Sombrero_Deep_serc_2012,Sombrero_Deep_serc_2013,
                                       Sombrero_Deep_serc_2014,Sombrero_Deep_serc_2016,Sombrero_Deep_serc_2017)
...
Sombrero_Deep_all <- rbind(Sombrero_Deep_serc_extra,Sombrero_Deep_2011_all)
Sombrero_Deep_all$sitename <- "Sombrero_Deep"

export(Sombrero_Deep_all,"MK_5km/Sombrero_Deep_combined.csv")





Sombrero_Shallow_serc <- import("MK_5km/Sombrero_Shallow_serc.xls")
Sombrero_Shallow_ws <- import("MK_5km/Sombrero_Shallow_ws.xls")
...
Sombrero_Shallow_serc_extra <- rbind(Sombrero_Shallow_serc_1995,Sombrero_Shallow_serc_1996,Sombrero_Shallow_serc_1997,Sombrero_Shallow_serc_1998,Sombrero_Shallow_serc_1999,Sombrero_Shallow_serc_2000,
                                  Sombrero_Shallow_serc_2001,Sombrero_Shallow_serc_2002,Sombrero_Shallow_serc_2003,
                                  Sombrero_Shallow_serc_2004,Sombrero_Shallow_serc_2005,Sombrero_Shallow_serc_2006,
                                  Sombrero_Shallow_serc_2007,Sombrero_Shallow_serc_2008,Sombrero_Shallow_serc_2009,
                                  Sombrero_Shallow_serc_2010,Sombrero_Shallow_serc_2012,Sombrero_Shallow_serc_2013,
                                  Sombrero_Shallow_serc_2014,Sombrero_Shallow_serc_2016,Sombrero_Shallow_serc_2017)
...
Sombrero_Shallow_all <- rbind(Sombrero_Shallow_serc_extra,Sombrero_Shallow_2011_all)
Sombrero_Shallow_all$sitename <- "Sombrero_Shallow"

export(Sombrero_Shallow_all,"MK_5km/Sombrero_Shallow_combined.csv")





Tennessee_Deep_serc <- import("MK_5km/Tennessee_Deep_serc.xls")
Tennessee_Deep_ws <- import("MK_5km/Tennessee_Deep_ws.xls")
...
export(Tennessee_Deep_all,"MK_5km/Tennessee_Deep_combined.csv")



Tennessee_Shallow_serc <- import("MK_5km/Tennessee_Shallow_serc.xls")
#Tennessee_Shallow_ws <- import("MK_5km/Tennessee_Shallow_ws.xls")
...
Tennessee_Shallow_serc_year$Longitude <- "NA"
Tennessee_Shallow_serc_year$Latitude <- "NA"
Tennessee_Shallow_serc_year$Depth <- "NA"
Tennessee_Shallow_serc_year$SST <- "NA"
Tennessee_Shallow_serc_year$SSS <- "NA"
Tennessee_Shallow_serc_year$Chl_a <- "NA"
Tennessee_Shallow_serc_year$Phaeophyti <- "NA"
Tennessee_Shallow_serc_year$id <- "NA"
...
Tennessee_Shallow_serc_year$sitename <- "Tennessee_Shallow"

export(Tennessee_Shallow_serc_year,"MK_5km/Tennessee_Shallow_combined.csv")



#Thor_serc <- import("MK_5km/Thor_serc.xls")
Thor_ws <- import("MK_5km/Thor_ws.xls")
...
Thor_ws_year$LATDEC <- "NA"
Thor_ws_year$LONDEC <- "NA"
Thor_ws_year$DEPTH <- "NA"
Thor_ws_year$NOX_S <- "NA"
Thor_ws_year$NOX_B <- "NA"
Thor_ws_year$NO3_S <- "NA"
Thor_ws_year$NO3_B <- "NA"
Thor_ws_year$NO2_S <- "NA"
Thor_ws_year$NO2_B <- "NA"
Thor_ws_year$NH4_S <- "NA"
Thor_ws_year$NH4_B <- "NA"
Thor_ws_year$TN_S <- "NA"
Thor_ws_year$TN_B <- "NA"
Thor_ws_year$DIN_S <- "NA"
Thor_ws_year$DIN_B <- "NA"
Thor_ws_year$TON_S <- "NA"
Thor_ws_year$TON_B <- "NA"
Thor_ws_year$TP_S <- "NA"
Thor_ws_year$TP_B <- "NA"
Thor_ws_year$SRP_S <- "NA"
Thor_ws_year$SRP_B <- "NA"
Thor_ws_year$APA_S <- "NA"
Thor_ws_year$APA_B <- "NA"
Thor_ws_year$CHLA_S <- "NA"
Thor_ws_year$CHLA_B <- "NA"
Thor_ws_year$TOC_S <- "NA"
Thor_ws_year$TOC_B <- "NA"
Thor_ws_year$SiO2_S <- "NA"
Thor_ws_year$SiO2_B <- "NA"
Thor_ws_year$TURB_S <- "NA"
Thor_ws_year$TURB_B <- "NA"
Thor_ws_year$SAL_S <- "NA"
Thor_ws_year$SAL_B <- "NA"
Thor_ws_year$TEMP_S <- "NA"
Thor_ws_year$TEMP_B <- "NA"
Thor_ws_year$DO_S <- "NA"
Thor_ws_year$DO_B <- "NA"
Thor_ws_year$Kd <- "NA"
Thor_ws_year$pH <- "NA"
Thor_ws_year$TN_TP <- "NA"
Thor_ws_year$N_P <- "NA"
Thor_ws_year$DIN_TP <- "NA"
Thor_ws_year$Si_DIN <- "NA"
Thor_ws_year$F_SAT_S <- "NA"
Thor_ws_year$F_SAT_B <- "NA"
Thor_ws_year$F_Io <- "NA"
Thor_ws_year$DSIGT <- "NA"
Thor_ws_year$id <- "NA"
...
Thor_ws_year$sitename <- "Thor"

export(Thor_ws_year,"MK_5km/Thor_combined.csv")



West_Turtle_Shoal_serc <- import("MK_5km/West_Turtle_Shoal_serc.xls")
#West_Turtle_Shoal_ws <- import("MK_5km/West_Turtle_Shoal_ws.xls")
...
West_Turtle_Shoal_serc_year$Longitude <- "NA"
West_Turtle_Shoal_serc_year$Latitude <- "NA"
West_Turtle_Shoal_serc_year$Depth <- "NA"
West_Turtle_Shoal_serc_year$SST <- "NA"
West_Turtle_Shoal_serc_year$SSS <- "NA"
West_Turtle_Shoal_serc_year$Chl_a <- "NA"
West_Turtle_Shoal_serc_year$Phaeophyti <- "NA"
West_Turtle_Shoal_serc_year$id <- "NA"
...
West_Turtle_Shoal_serc_year$sitename <- "West_Turtle_Shoal"

export(West_Turtle_Shoal_serc_year,"MK_5km/West_Turtle_Shoal_combined.csv")


### Combine all Middle Keys

Middle_Keys_all <- rbind(Alligator_Deep_serc_year,Alligator_Shallow_serc_year,
                         Dustan_Rocks_all,Long_Key_all,Molasses_Keys_all,
                         Moser_Channel_all,Rawa_Reef_serc_year,Sombrero_Deep_all,
                         Sombrero_Shallow_all,Tennessee_Deep_all,Tennessee_Shallow_serc_year,
                         Thor_ws_year,West_Turtle_Shoal_serc_year)

export(Middle_Keys_all,"MK_5km/MK_Nutrients_Combined.csv")


### Upper Keys 

Admiral_serc <- import("UK_5km/Admiral_serc.xls")
Admiral_ws <- import("UK_5km/Admiral_ws.xls")
...
Admiral_serc_extra <- rbind(Admiral_serc_1995,Admiral_serc_1996,Admiral_serc_1997,
                            Admiral_serc_1998,Admiral_serc_1999,Admiral_serc_2000,
                            Admiral_serc_2001,Admiral_serc_2002,Admiral_serc_2003,
                            Admiral_serc_2004,Admiral_serc_2005,Admiral_serc_2006,
                            Admiral_serc_2007,Admiral_serc_2008,Admiral_serc_2009,
                            Admiral_serc_2010,Admiral_serc_2011,Admiral_serc_2012,
                            Admiral_serc_2013,Admiral_serc_2014)
...
Admiral_all <- rbind(Admiral_serc_extra,Admiral_2015_all,Admiral_2016_all,Admiral_2017_all,Admiral_ws_2018_all)
Admiral_all$sitename <- "Admiral"


export(Admiral_all,"UK_5km/Admiral_combined.csv")





Burr_Fish_serc <- import("UK_5km/Burr_Fish_serc.xls")
Burr_Fish_ws <- import("UK_5km/Burr_Fish_ws.xls")
...
Burr_Fish_serc_extra <- rbind(Burr_Fish_serc_1995,Burr_Fish_serc_1996,
                              Burr_Fish_serc_1997,Burr_Fish_serc_1998,
                              Burr_Fish_serc_1999,Burr_Fish_serc_2003,
                              Burr_Fish_serc_2004,Burr_Fish_serc_2005,
                              Burr_Fish_serc_2006,Burr_Fish_serc_2007,
                              Burr_Fish_serc_2008,Burr_Fish_serc_2009,
                              Burr_Fish_serc_2010,Burr_Fish_serc_2011,
                              Burr_Fish_serc_2012,Burr_Fish_serc_2013,
                              Burr_Fish_serc_2014,Burr_Fish_serc_2015,
                              Burr_Fish_serc_2016,Burr_Fish_serc_2017)
...
Burr_Fish_all <- rbind(Burr_Fish_serc_extra,Burr_Fish_2000_all,Burr_Fish_2001_all,Burr_Fish_2002_all)
Burr_Fish_all$sitename <- "Burr_Fish"

export(Burr_Fish_all,"UK_5km/Burr_Fish_combined.csv")



Carysfort_Deep_serc <- import("UK_5km/Carysfort_Deep_serc.xls")
#Carysfort_Deep_ws <- import("UK_5km/Carysfort_Deep_ws.xls")
...
Carysfort_Deep_serc_year$Longitude <- "NA"
Carysfort_Deep_serc_year$Latitude <- "NA"
Carysfort_Deep_serc_year$Depth <- "NA"
Carysfort_Deep_serc_year$SST <- "NA"
Carysfort_Deep_serc_year$SSS <- "NA"
Carysfort_Deep_serc_year$Chl_a <- "NA"
Carysfort_Deep_serc_year$Phaeophyti <- "NA"
Carysfort_Deep_serc_year$id <- "NA"
...
Carysfort_Deep_serc_year$sitename <- "Carysfort_Deep"

export(Carysfort_Deep_serc_year,"UK_5km/Carysfort_Deep_combined.csv")



Carysfort_Shallow_serc <- import("UK_5km/Carysfort_Shallow_serc.xls")
#Carysfort_Shallow_ws <- import("UK_5km/Carysfort_Shallow_ws.xls")
...
Carysfort_Shallow_serc_year$Longitude <- "NA"
Carysfort_Shallow_serc_year$Latitude <- "NA"
Carysfort_Shallow_serc_year$Depth <- "NA"
Carysfort_Shallow_serc_year$SST <- "NA"
Carysfort_Shallow_serc_year$SSS <- "NA"
Carysfort_Shallow_serc_year$Chl_a <- "NA"
Carysfort_Shallow_serc_year$Phaeophyti <- "NA"
Carysfort_Shallow_serc_year$id <- "NA"
...
Carysfort_Shallow_serc_year$sitename <- "Carysfort_Shallow"

export(Carysfort_Shallow_serc_year,"UK_5km/Carysfort_Shallow_combined.csv")




Conch_Deep_serc <- import("UK_5km/Conch_Deep_serc.xls")
Conch_Deep_ws <- import("UK_5km/Conch_Deep_ws.xls")
...
Conch_Deep_serc_extra <- rbind(Conch_Deep_serc_1995,Conch_Deep_serc_1996,
                               Conch_Deep_serc_1997,Conch_Deep_serc_1998,
                               Conch_Deep_serc_1999,Conch_Deep_serc_2003,
                               Conch_Deep_serc_2004,Conch_Deep_serc_2005,
                               Conch_Deep_serc_2006,Conch_Deep_serc_2007,
                               Conch_Deep_serc_2008,Conch_Deep_serc_2009,
                               Conch_Deep_serc_2010,Conch_Deep_serc_2011,
                               Conch_Deep_serc_2012,Conch_Deep_serc_2013,
                               Conch_Deep_serc_2014,Conch_Deep_serc_2015,
                               Conch_Deep_serc_2016,Conch_Deep_serc_2017)
...
Conch_Deep_all <- rbind(Conch_Deep_serc_extra,Conch_Deep_2000_all,Conch_Deep_2001_all,Conch_Deep_2002_all)
Conch_Deep_all$sitename <- "Conch_Deep"

export(Conch_Deep_all,"UK_5km/Conch_Deep_combined.csv")



Conch_Shallow_serc <- import("UK_5km/Conch_Shallow_serc.xls")
# Conch_Shallow_ws <- import("UK_5km/Conch_Shallow_ws.xls")
...
Conch_Shallow_serc_year$Longitude <- "NA"
Conch_Shallow_serc_year$Latitude <- "NA"
Conch_Shallow_serc_year$Depth <- "NA"
Conch_Shallow_serc_year$SST <- "NA"
Conch_Shallow_serc_year$SSS <- "NA"
Conch_Shallow_serc_year$Chl_a <- "NA"
Conch_Shallow_serc_year$Phaeophyti <- "NA"
Conch_Shallow_serc_year$id <- "NA"
...
Conch_Shallow_serc_year$sitename <- "Conch_Shallow"

export(Conch_Shallow_serc_year,"UK_5km/Conch_Shallow_combined.csv")



Dove_Key_serc <- import("UK_5km/Dove_Key_serc.xls")
Dove_Key_ws <- import("UK_5km/Dove_Key_ws.xls")
...
Dove_Key_serc_extra <- rbind(Dove_Key_serc_1995,Dove_Key_serc_1996,
                             Dove_Key_serc_1997,Dove_Key_serc_1998,
                             Dove_Key_serc_1999,Dove_Key_serc_2003,
                             Dove_Key_serc_2004,Dove_Key_serc_2005,
                             Dove_Key_serc_2006,Dove_Key_serc_2007,
                             Dove_Key_serc_2008,Dove_Key_serc_2009,
                             Dove_Key_serc_2010,Dove_Key_serc_2011,
                             Dove_Key_serc_2012,Dove_Key_serc_2013,
                             Dove_Key_serc_2014,Dove_Key_serc_2015,
                             Dove_Key_serc_2016,Dove_Key_serc_2017)
...
Dove_Key_all <- rbind(Dove_Key_serc_extra,Dove_Key_2000_all,Dove_Key_2001_all,Dove_Key_2002_all)
Dove_Key_all$sitename <- "Dove_Key_all"

export(Dove_Key_all,"UK_5km/Dove_Key_combined.csv")



El_Radabob_serc <- import("UK_5km/El_Radabob_serc.xls")
El_Radabob_ws <- import("UK_5km/El_Radabob_ws.xls")
...
export(El_Radabob_all,"UK_5km/El_Radabob_combined.csv")




Grecian_Rocks_serc <- import("UK_5km/Grecian_Rocks_serc.xls")
Grecian_Rocks_ws <- import("UK_5km/Grecian_Rocks_ws.xls")
...
export(Grecian_Rocks_all,"UK_5km/Grecian_Rocks_combined.csv")



Molasses_Deep_serc <- import("UK_5km/Molasses_Deep_serc.xls")
Molasses_Deep_ws <- import("UK_5km/Molasses_Deep_ws.xls")
...
Molasses_Deep_serc_extra <- rbind(Molasses_Deep_serc_1995,Molasses_Deep_serc_1996,
                                  Molasses_Deep_serc_1997,Molasses_Deep_serc_1998,
                                  Molasses_Deep_serc_1999,Molasses_Deep_serc_2000,
                                  Molasses_Deep_serc_2001,Molasses_Deep_serc_2002,
                                  Molasses_Deep_serc_2003,Molasses_Deep_serc_2004,
                                  Molasses_Deep_serc_2005,Molasses_Deep_serc_2006,
                                  Molasses_Deep_serc_2007,Molasses_Deep_serc_2008,
                                  Molasses_Deep_serc_2009,Molasses_Deep_serc_2010,
                                  Molasses_Deep_serc_2011,Molasses_Deep_serc_2012,
                                  Molasses_Deep_serc_2013,Molasses_Deep_serc_2014)
...
Molasses_Deep_all <- rbind(Molasses_Deep_serc_extra,Molasses_Deep_2015_all,Molasses_Deep_2016_all,Molasses_Deep_2017_all,Molasses_Deep_ws_2018_all)
Molasses_Deep_all$sitename <- "Molasses_Deep"

export(Molasses_Deep_all,"UK_5km/Molasses_Deep_combined.csv")



Molasses_Shallow_serc <- import("UK_5km/Molasses_Shallow_serc.xls")
Molasses_Shallow_ws <- import("UK_5km/Molasses_Shallow_ws.xls")
...
Molasses_Shallow_serc_extra <- rbind(Molasses_Shallow_serc_1995,Molasses_Shallow_serc_1996,
                                  Molasses_Shallow_serc_1997,Molasses_Shallow_serc_1998,
                                  Molasses_Shallow_serc_1999,Molasses_Shallow_serc_2000,
                                  Molasses_Shallow_serc_2001,Molasses_Shallow_serc_2002,
                                  Molasses_Shallow_serc_2003,Molasses_Shallow_serc_2004,
                                  Molasses_Shallow_serc_2005,Molasses_Shallow_serc_2006,
                                  Molasses_Shallow_serc_2007,Molasses_Shallow_serc_2008,
                                  Molasses_Shallow_serc_2009,Molasses_Shallow_serc_2010,
                                  Molasses_Shallow_serc_2011,Molasses_Shallow_serc_2012,
                                  Molasses_Shallow_serc_2013,Molasses_Shallow_serc_2014)
...
Molasses_Shallow_all <- rbind(Molasses_Shallow_serc_extra,Molasses_Shallow_2015_all,Molasses_Shallow_2016_all,Molasses_Shallow_2017_all,Molasses_Shallow_ws_2018_all)
Molasses_Shallow_all$sitename <- "Molasses_Shallow"

export(Molasses_Shallow_all,"UK_5km/Molasses_Shallow_combined.csv")



Porter_Patch_serc <- import("UK_5km/Porter_Patch_serc.xls")
Porter_Patch_ws <- import("UK_5km/Porter_Patch_ws.xls")
...
export(Porter_Patch_all,"UK_5km/Porter_Patch_combined.csv")




Rattlesnake_serc <- import("UK_5km/Rattlesnake_serc.xls")
Rattlesnake_ws <- import("UK_5km/Rattlesnake_ws.xls")
...
Rattlesnake_serc_extra <- rbind(Rattlesnake_serc_1995,Rattlesnake_serc_1996,
                                Rattlesnake_serc_1997,Rattlesnake_serc_1998,
                                Rattlesnake_serc_1999,Rattlesnake_serc_2003,
                                Rattlesnake_serc_2004,Rattlesnake_serc_2005,
                                Rattlesnake_serc_2006,Rattlesnake_serc_2007,
                                Rattlesnake_serc_2008,Rattlesnake_serc_2009,
                                Rattlesnake_serc_2010,Rattlesnake_serc_2011,
                                Rattlesnake_serc_2012,Rattlesnake_serc_2013,
                                Rattlesnake_serc_2014,Rattlesnake_serc_2015,
                                Rattlesnake_serc_2016,Rattlesnake_serc_2017)
...
Rattlesnake_all <- rbind(Rattlesnake_serc_extra,Rattlesnake_2000_all,Rattlesnake_2001_all,Rattlesnake_2002_all)
Rattlesnake_all$sitename <- "Rattlesnake"

export(Rattlesnake_all,"UK_5km/Rattlesnake_combined.csv")




Turtle_serc <- import("UK_5km/Turtle_serc.xls")
Turtle_ws <- import("UK_5km/Turtle_ws.xls")
...
export(Turtle_all,"UK_5km/Turtle_combined.csv")




Two_Patches_serc <- import("UK_5km/Two_Patches_serc.xls")
Two_Patches_ws <- import("UK_5km/Two_Patches_ws.xls")
...
Two_Patches_serc_extra <- rbind(Two_Patches_serc_1995,Two_Patches_serc_1996,
                                Two_Patches_serc_1997,Two_Patches_serc_1998,
                                Two_Patches_serc_1999,Two_Patches_serc_2003,
                                Two_Patches_serc_2004,Two_Patches_serc_2005,
                                Two_Patches_serc_2006,Two_Patches_serc_2007,
                                Two_Patches_serc_2008,Two_Patches_serc_2009,
                                Two_Patches_serc_2010,Two_Patches_serc_2011,
                                Two_Patches_serc_2012,Two_Patches_serc_2013,
                                Two_Patches_serc_2014,Two_Patches_serc_2015,
                                Two_Patches_serc_2016,Two_Patches_serc_2017)
...
Two_Patches_all <- rbind(Two_Patches_serc_extra,Two_Patches_2000_all,Two_Patches_2001_all,Two_Patches_2002_all)
Two_Patches_all$sitename <- "Two_Patches"

export(Two_Patches_all,"UK_5km/Two_Patches_combined.csv")
...
Upper_Keys_all <- rbind (Admiral_all,Burr_Fish_all,Carysfort_Deep_serc_year,
                         Carysfort_Shallow_serc_year,Conch_Deep_all,Conch_Shallow_serc_year,
                         Dove_Key_all,El_Radabob_all,Grecian_Rocks_all,
                         Molasses_Deep_all,Molasses_Shallow_all,Porter_Patch_all,
                         Rattlesnake_all,Turtle_all,Two_Patches_all)

export(Upper_Keys_all,"UK_5km/UK_Nutrients_Combined.csv")


#### Combine entire regions

DT <- read_csv("DT_5km/DT_Nutrients_Combined.csv")
DT$subregion <- "DT"

LK <- read_csv("LK_5km/LK_Nutrients_Combined.csv")
LK$subregion <- "LK"

MK <- read_csv("MK_5km/MK_Nutrients_Combined.csv")
MK$subregion <- "MK"

UK <- read_csv("UK_5km/UK_Nutrients_Combined.csv")
UK$subregion <- "UK"

All_regions_nutrients <- rbind(DT,LK,MK,UK)


export(All_regions_nutrients,"All_Regions_Nutrients_5km.csv")
